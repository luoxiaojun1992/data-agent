...
func TestListNotifications_Success(t *testing.T) {
	...
	svc.On("ListForUser", mock.Anything).Return( notifs, nil)
...
func TestListNotifications_WithLimit(t *testing.T) {
	...
	svc.On("ListForUser", mock.Anything).Return( []model.Notification{}, nil)
...
func TestListNotifications_Error(t *testing.T) {
	...
	svc.On("ListForUser", mock.Anything).Return( nil, fmt.Errorf("db error"))
...
func TestMarkRead_Success(t *testing.T) {
	...
	svc.On("MarkRead", mock.Anything).Return( nil)
...
func TestMarkRead_Error(t *testing.T) {
	...
	svc.On("MarkRead", mock.Anything).Return( fmt.Errorf("invalid id"))
...
func TestSendNotification_Success(t *testing.T) {
	...
	svc.On("Send", mock.Anything).Return( n, nil)
...
func TestSendNotification_ServiceError(t *testing.T) {
	...
	svc.On("Send", mock.Anything).Return( nil, fmt.Errorf("db error"))
...
func TestBroadcastNotification_Success(t *testing.T) {
	...
	svc.On("Broadcast", mock.Anything).Return( n, nil)
...
func TestBroadcastNotification_ServiceError(t *testing.T) {
	...
	svc.On("Broadcast", mock.Anything).Return( nil, fmt.Errorf("db error"))
