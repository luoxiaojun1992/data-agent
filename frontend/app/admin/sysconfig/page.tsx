      ...
      <div className="animate-fade-in" data-testid="sysconfig-page-header">
        ...
        <div className="glass" data-testid="sysconfig-session-recovery" style={cardStyle}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <input
                data-testid="sysconfig-session-recovery-input"
                type="number"
                min={1} max={168}
              ...
              <button
                data-testid="sysconfig-session-recovery-save"
                onClick={() => save('session_recovery_hours', sessionRecovery)}
                style={btnStyle}
              >
                保存
              </button>
          ...
          {error && <p data-testid="sysconfig-session-recovery-error" style={{ color: '#ef4444', fontSize: '12px', marginTop: '8px' }}>{error}</p>}
        </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <input
                ...
                min={1}
                value={notifTTL}
                onChange={(e) => setNotifTTL(Number(e.target.value))}
                style={inputStyle}
              />
              <span style={{ fontSize: '13px', color: '#7A7A7A' }}>天</span>
        ...
        <div className="glass" data-testid="sysconfig-email-whitelist" style={cardStyle}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <input
              data-testid="sysconfig-email-input"
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <input
                ...
                min={1}
                value={reportRetry}
                onChange={(e) => setReportRetry(Number(e.target.value))}
                style={inputStyle}
              />
...
const titleStyle: React.CSSProperties = {
  fontSize: '15px', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '4px',
};
