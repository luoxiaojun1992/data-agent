...
| SPEC-008 | 数据分析 Logic 层 | P2～3 | [spec-008-data-analysis-logic.md](spec-008-data-analysis-logic.md) | 🚧 设计中 |
...
| P2～3 | SPEC-008 | 数据分析 Logic 层 | SPEC-003, 004, 005 |
| P2～4 | SPEC-007 | Skill 实现层 | SPEC-004, 005, 006, 008 |
