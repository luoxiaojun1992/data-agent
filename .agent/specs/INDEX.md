...
| SPEC-098 | pptx skill 优化 — 同时支持 Markdown 与 HTML（HTML 支持表格/图片/逐元素样式更精美；同步原始 seed 数据） | **P15** | [spec-098-pptx-skill-html-support.md](spec-098-pptx-skill-html-support.md) | 📝 立项（待深化；暂不实现） |
