...
| SPEC-100 | 优化 Token 用量埋点（sessionID 维度 + 时间冗余字段 + 索引 + 趋势聚合优化 + session token 展示） | **P15** | [spec-100-token-metrics-session-and-time-redundancy.md](spec-100-token-metrics-session-and-time-redundancy.md) | 📐 立项（暂不展开） |
