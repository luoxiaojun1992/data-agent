...
| SPEC-007 | Skill 实现层（Logic + Skill 分层） | P2～4 | [spec-007-skill-implementations.md](spec-007-skill-implementations.md) | 🚧 设计中 |
...
| SPEC-008 | ~~安全审计层~~ | — | [spec-008-security-report-validation.md](spec-008-security-report-validation.md) | 🗄️ 已废弃 |
...
| 🗄️ | SPEC-008 | Superseded by SPEC-004 | — |
...
[P1]  SPEC-003 ─── Infrastructure
    ...
    ┌────┴──────────────┬──────────────────┐
    ▼                   ▼                  ▼
[P2] SPEC-004       [P2] SPEC-006    [P2~4] SPEC-014
    Agent Core          Artifact           Task Queue
    (+Security)         │                  + Scheduler
    │  │                │                  │
    ▼  │                │                  │
[P3]    │                │                  │
...
[P2~4]    SPEC-007 ───────┘                  │
    ...
    ┌─────┘                                  │
    ▼                                        ▼
[P4] SPEC-010 (IM) ──► [P5] SPEC-012 (Admin)
                             │
