...
| SPEC-004 | Agent 核心引擎与服务 | **P2** | [spec-004-agent-engine.md](spec-004-agent-engine.md) | 🚧 设计中 |
...
| SPEC-008 | 安全审计层 | **P4** | [spec-008-security-report-validation.md](spec-008-security-report-validation.md) | 🚧 设计中 |
...
| SPEC-013 | 测试体系与生产部署 | **P6** | [spec-013-testing-deploy.md](spec-013-testing-deploy.md) | 🚧 设计中 |
...
| **P2** | SPEC-004 | Agent 核心引擎与服务 | SPEC-003 |
| **P2** | SPEC-006 | Artifact 存储与工作区 | SPEC-003, 004 |
| **P3** | SPEC-005 | 知识库系统 | SPEC-004 |
| P2～4 | SPEC-007 | Skill 实现层 | SPEC-004, 005, 006 |
| **P4** | SPEC-008 | 安全审计层 | SPEC-004 |
| **P4** | SPEC-009 | 系统统计监控 | SPEC-004, 007 |
| **P4** | SPEC-010 | IM 集成（飞书） | SPEC-004 |
| **P5** | SPEC-011 | Hermes 自由探索 | 独立 |
| **P5** | SPEC-012 | 管理后台 | SPEC-004, 008, 009, 010 |
| **P6** | SPEC-013 | 测试体系与生产部署 | 全部 |
...
SPEC-005 │  │                  │
   KB    │  │                  │
    ...
    ├────┘  └──────────────────┤
    ▼                          ▼
[P2~4]    SPEC-007 ─── Skills
          │
          ▼
     [P4] SPEC-009 ─── Stats Monitoring

    ┌──────────────────┐
    ▼                  │
[P4] SPEC-008 ──► [P4] SPEC-010 (IM)
    Security ← 004     ← 004
     │                  │
     └──────────┬───────┘
                │
    ┌───────────┘
    ▼           ▼
[P5] SPEC-011  [P5] SPEC-012
    Hermes          Admin Dashboard
    (独立)          ← 004,008,009,010
     │               │
     └───────┬───────┘
             ▼
[P6]      SPEC-013 ─── Test + Deploy
```
