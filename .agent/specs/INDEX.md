...
| SPEC-065 | 配置存储拆分（system_configs 去 namespace；模型配置每模型一条文档+DB分页；model_defaults 独立集合；skill 独立集合） | **P15** | [spec-065-config-storage-split.md](spec-065-config-storage-split.md) | 📐 设计中 |
