...
| P1-10 | RBAC 引擎（三级角色：system_admin/admin/user + 权限矩阵） | 6h | P1-05, P1-09 |
| P1-10a | 系统管理员自动创建（启动检测 + 16位随机密码 + 日志输出） | 2h | P1-10 |
...
| P5-11a | 站内信页面（收发 + 群发 + 全站发送） | 4h | P5-02 |
| P5-11b | 修改密码页面 | 2h | P5-02 |
| P5-11c | 删除确认弹窗组件（统一样式，全局复用） | 2h | P5-02 |
