...
| Phase 2 | W3-4 | SPEC-004, SPEC-006, SPEC-008 | Agent 核心引擎（含安全审计）+ Artifact + 数据分析 Logic 基础 |
| Phase 3 | W5-6 | SPEC-005, SPEC-008 | 知识库系统 + 数据分析 Logic 完成 |
