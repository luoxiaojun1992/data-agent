...
| SPEC-005 | **P2** | Artifact 存储与工作区管理 | 🚧 设计中 |
| SPEC-006 | **P3** | 知识库系统 | 🚧 设计中 |
| SPEC-007 | **P3** | 数据分析 Logic 层 | 🚧 设计中 |
| SPEC-008 | **P4** | Skill 实现层 | 🚧 设计中 |
| SPEC-009 | **P4** | 任务队列与调度基础设施 | 🚧 设计中 |
| SPEC-010 | **P4** | 系统统计监控 | 🚧 设计中 |
| SPEC-011 | **P4** | IM 集成（飞书机器人） | 🚧 设计中 |
| SPEC-012 | **P5** | Hermes 自由探索模式 | 🚧 设计中 |
| SPEC-013 | **P5** | 管理后台 | 🚧 设计中 |
| SPEC-014 | **P6** | 测试体系 | 🚧 设计中 |
